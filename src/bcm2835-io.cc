...
void AIInit(const Nan::FunctionCallbackInfo<v8::Value>& info) {
#ifdef __arm__
    uint8_t value = pe2a_AI_init();
    info.GetReturnValue().Set(value);
#else
#endif
}

void AOInit(const Nan::FunctionCallbackInfo<v8::Value>& info) {
#ifdef __arm__
    uint8_t value = pe2a_AO_init();
    info.GetReturnValue().Set(value);
#else
#endif
}

void DOIInit(const Nan::FunctionCallbackInfo<v8::Value>& info) {
#ifdef __arm__
    uint8_t value = pe2a_DO_DI_init();
    info.GetReturnValue().Set(value);
#else
#endif
}

void AIGetVal(const Nan::FunctionCallbackInfo<v8::Value>& info) {
#ifdef __arm__
    uint8_t value = pe2a_AI_getVal(info[0]->NumberValue());
    info.GetReturnValue().Set(value);
#else
#endif
}

void AOWriteVal(const Nan::FunctionCallbackInfo<v8::Value>& info) {
#ifdef __arm__
    pe2a_AO_writeVal(info[0]->NumberValue(), info[1]->NumberValue());
#else
#endif
}

void DOSetHigh(const Nan::FunctionCallbackInfo<v8::Value>& info) {
#ifdef __arm__
    pe2a_DO_setHigh(info[0]->NumberValue());
#else
#endif
}

void DOSetLow(const Nan::FunctionCallbackInfo<v8::Value>& info) {
#ifdef __arm__
    pe2a_DO_setLow(info[0]->NumberValue());
#else
#endif
}

void DIGetVal(const Nan::FunctionCallbackInfo<v8::Value>& info) {
#ifdef __arm__
    uint8_t value = pe2a_DI_getVal(info[0]->NumberValue());
    info.GetReturnValue().Set(value);
#else
#endif
}

void GetTemperatureInit(const Nan::FunctionCallbackInfo<v8::Value>& info) {
#ifdef __arm__
    uint8_t value = pe2a_getTemperature_init();
    info.GetReturnValue().Set(value);
#else
#endif
}

void GetTemperature(const Nan::FunctionCallbackInfo<v8::Value>& info) {
#ifdef __arm__
    info.GetReturnValue().Set(pe2a_getTemperature(info[0]->NumberValue()));
#else
#endif
}

void MedIOExClose(const Nan::FunctionCallbackInfo<v8::Value>& info) {
#ifdef __arm__
    pe2a_bcm2835_close();
#else
#endif
...
void Init(v8::Local<v8::Object> exports) {
    ...
    // MedIOEx
    exports->Set(Nan::New("analogInputInit").ToLocalChecked(),
                 Nan::New<v8::FunctionTemplate>(AIInit)->GetFunction());
    exports->Set(Nan::New("analogOutputInit").ToLocalChecked(),
                 Nan::New<v8::FunctionTemplate>(AOInit)->GetFunction());
    exports->Set(Nan::New("digitalOutputInputInit").ToLocalChecked(),
                 Nan::New<v8::FunctionTemplate>(DOIInit)->GetFunction());
    exports->Set(Nan::New("analogGetValue").ToLocalChecked(),
                 Nan::New<v8::FunctionTemplate>(AIGetVal)->GetFunction());
    exports->Set(Nan::New("analogWriteValue").ToLocalChecked(),
                 Nan::New<v8::FunctionTemplate>(AOWriteVal)->GetFunction());
    exports->Set(Nan::New("digitalSetHigh").ToLocalChecked(),
                 Nan::New<v8::FunctionTemplate>(DOSetHigh)->GetFunction());
    exports->Set(Nan::New("digitalSetLow").ToLocalChecked(),
                 Nan::New<v8::FunctionTemplate>(DOSetLow)->GetFunction());
    exports->Set(Nan::New("digitalGetValue").ToLocalChecked(),
                 Nan::New<v8::FunctionTemplate>(DIGetVal)->GetFunction());
    exports->Set(Nan::New("getTemperatureInit").ToLocalChecked(),
                 Nan::New<v8::FunctionTemplate>(GetTemperatureInit)->GetFunction());
    exports->Set(Nan::New("getTemperature").ToLocalChecked(),
                 Nan::New<v8::FunctionTemplate>(GetTemperature)->GetFunction());
    exports->Set(Nan::New("medIOExClose").ToLocalChecked(),
                 Nan::New<v8::FunctionTemplate>(MedIOExClose)->GetFunction());
